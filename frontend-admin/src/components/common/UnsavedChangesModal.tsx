...
export default function UnsavedChangesModal({
  ...
  description = 'Bạn đang có các thay đổi chưa được lưu trên trang này. Nếu rời khỏi trang lúc này, toàn bộ thông tin bạn vừa nhập sẽ bị mất.',
  ...
  const handleConfirm = () => {
    ...
    else if (onConfirmLeave) onConfirmLeave()
  }
