      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0 space-y-1">
            <h3 className="text-base font-bold text-slate-900">Xóa Pipeline Template?</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Bạn có chắc chắn muốn xóa pipeline template <strong className="text-slate-800 font-bold">“{templateName}”</strong> không? Hành động này sẽ xóa vĩnh viễn template và không thể hoàn tác.
            </p>
          </div>
          <button
            type="button"
